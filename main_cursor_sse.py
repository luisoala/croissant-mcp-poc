"""
Main entry point for the Croissant MCP Server with Cursor-compatible SSE endpoint
"""
import os
import sys
import uvicorn
...
from server_cursor_sse import app

if __name__ == "__main__":
    api_key = os.environ.get("MCP_API_KEY", "croissant-mcp-demo-key")
    
    print("Starting Croissant MCP Server with Cursor-compatible SSE endpoint...")
    print("Available datasets will be indexed and searchable via MCP")
    print("Server will be available at http://0.0.0.0:8000")
    print("Access SSE endpoint at http://0.0.0.0:8000/sse")
