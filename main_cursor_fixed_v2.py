...
from server_cursor_fixed_v2 import app
...
if __name__ == "__main__":
    ...
    print("Custom SSE endpoint available at http://0.0.0.0:8000/mcp/sse")
    print("Custom JSON-RPC endpoint available at http://0.0.0.0:8000/mcp/jsonrpc")
